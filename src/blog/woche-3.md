...
<h2 style="position: relative;" id="tag-4"><a href="#tag-4" aria-label="tag 4 Permalink" class="blog-header-link before"><svg aria-hidden="true" focusable="false" height="20" version="1.1" viewbox="0 0 16 16" width="20"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Tag 4 Oberkörper 2 - 12.08.2022</h2>

<figure>

<img class="img-fluid" src="/images/woche-3/woche-3-tag-4-ok-2.png" alt="Trainingsplan zu der Woche 3 Tag 2 Oberkörper 1">
<figcaption>Tag 4 Oberkörper 2 - 12.08.2022</figcaption>

</figure>

An dem Tag war ich ganz alleine im Gym. Aber bei OK ist es kein Problem, obwohl es nett wäre, wenn mir beim Drücken raushelfen würde. Aber insgesamt anstrengende Einheit. Ich musste Bauch und Rhomb Rows nachholen 🫠.

---

In dieser Woche war der Muskelkater ordentlich. D.h. Die Lasten sind noch bewegbar und die Steigerungen von Woche zu Woche werden jetzt immer kleiner. Bin zufrieden. Vieles kann ich mit Technik kompensieren. Trotz Diät kann es also voran gehen.

Mit täglicher Dehnung, die ich als Hausaufgaben bekommen habe, kann ich ebenfalls meine Technik verbessern. Perfekt halt.
